...
#include "/content/libcusparse_lt-linux-x86_64-0.3.0.3-archive/include/cusparseLt.h"
#include <stdio.h>
#include <stdlib.h>
...
float alpha = 1.0f;
float beta  = 0.0f;
__half* dA = malloc(n*sizeof(__half));
__half* dB = malloc(n*sizeof(__half));
__half* dC = malloc(n*sizeof(__half));
